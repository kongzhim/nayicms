...
<div class="serv_right" style='padding:20px;'>
    ...
    <table class='table'>
        <tr>
            ...
            <td width="83%"><input type='text' name='name' value='<?php echo ($info["name"]); ?>' class='input'>只允许英文字母。</td>
        </tr>
        <tr>
            <td><div align="right">配置别名</div></td>
            <td><input type='text' name='cname' value='<?php echo ($info["cname"]); ?>' class='input'></td>
        </tr>
        <tr>
            <td><div align="right">配置值</div></td>
            <td><textarea name='value' class='textarea'> <?php echo ($info["value"]); ?></textarea></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
